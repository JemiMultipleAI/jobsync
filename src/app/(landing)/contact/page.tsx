  ...
  const contactMethods = [
    {
      ...
      title: "Email Us",
      description: "Send us your questions or inquiries",
      action: "support@jobsync.au",
      details: "We reply within 24 hours",
      link: "mailto:support@jobsync.au",
    },
    {
    ...
    <div className="min-h-screen bg-white dark:bg-gray-900">
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-8 max-w-3xl mx-auto">
            {contactMethods.map((method, index) => (
              <Card key={index} className="bg-white dark:bg-gray-800 text-center p-8 hover:shadow-lg transition-shadow border border-gray-200 dark:border-gray-700">
                <div className="flex justify-center mb-4 text-[#B260E6]">
                  {method.icon}
                </div>
                <h3 className="text-xl font-semibold mb-2 text-gray-900 dark:text-gray-100">{method.title}</h3>
                <p className="text-gray-600 dark:text-gray-300 mb-4">{method.description}</p>
                <a 
                  href={method.link} 
                  className="block font-medium text-[#ED84A5] mb-1 hover:text-[#B260E6] transition-colors text-lg"
                >
                  {method.action}
                </a>
      ...
      <section className="py-16 bg-gray-50 dark:bg-gray-800">
        <div className="max-w-4xl mx-auto px-6">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold mb-4 text-gray-900 dark:text-gray-100">Send Us a Message</h2>
            <p className="text-lg text-gray-600 dark:text-gray-300">Fill out the form below and we&apos;ll get back to you as soon as possible.</p>
          </div>
      ...
      <section className="py-24 bg-gray-50 dark:bg-gray-800">
        <div className="max-w-5xl mx-auto px-6 text-center">
          ...
          <Card className="bg-white dark:bg-gray-800 max-w-2xl mx-auto border border-gray-200 dark:border-gray-700 shadow-lg">
            <CardContent className="p-8">
              <div className="flex items-start gap-4 text-left">
                <MapPin className="h-6 w-6 text-[#B260E6] mt-1 flex-shrink-0" />
                <div>
                  <h3 className="text-xl font-semibold mb-2 text-gray-900 dark:text-gray-100">JobSync Headquarters</h3>
