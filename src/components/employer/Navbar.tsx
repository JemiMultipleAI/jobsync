      ...
      <div className="ml-auto flex items-center gap-4">
          ...
          <DropdownMenuContent align="end" className="w-80">
            ...
            <div className="p-2">
              <div className="space-y-2">
                ...
                <div className="text-sm p-2 rounded-lg bg-muted/50">
                  <p className="font-medium">Candidate viewed your job</p>
        ...
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            ...
            >
              <Avatar className="h-9 w-9 ring-2 ring-transparent hover:ring-primary/30 transition-all">
                {user?.profileImage && (
                  <AvatarImage src={user.profileImage} alt={user.name || "Employer"} />
                )}
          ...
          <DropdownMenuContent align="end" className="w-56">
            ...
            <DropdownMenuSeparator />
            <DropdownMenuItem onClick={() => router.push("/employer/company")}>
