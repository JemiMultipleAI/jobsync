      ...
      <section className="relative pt-32 pb-24 overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-6 text-center text-white">
          <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">
            About <span className="bg-gradient-to-r from-white to-gray-200 bg-clip-text text-transparent">
              JobSync
            </span>
          </h1>
          <p className="text-xl md:text-2xl mb-8 max-w-3xl mx-auto leading-relaxed">
            Australia&apos;s premier platform connecting skilled workers with meaningful employment opportunities
          </p>
        </div>
      </section>

      {/* What is JobSync Section */}
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <div className="space-y-6 text-lg text-gray-700 dark:text-gray-300 leading-relaxed">
                <p>
                  <strong className="text-[#B260E6]">JobSync</strong> is Australia&apos;s leading workforce platform designed to connect skilled professionals with trusted employers across the nation. We specialize in verified credentials, seamless job matching, and building stronger Australian communities through meaningful employment.
                </p>
                <p>
                  Our platform serves as a bridge between talented workers and businesses, ensuring that every connection is built on trust, verification, and mutual success. We understand the unique needs of Australia&apos;s skilled trades and professional sectors, providing tailored solutions that benefit both job seekers and employers.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <div className="space-y-6 text-lg text-gray-700 dark:text-gray-300 leading-relaxed">
                <p>
                  Our primary goal is to <strong className="text-[#B260E6]">transform the Australian employment landscape</strong> by making job searching and talent acquisition more efficient, transparent, and accessible for everyone.
                </p>
                <p>
                  We aim to:
                </p>
                <ul className="list-disc list-inside space-y-3 text-left max-w-2xl mx-auto">
                  <li>Eliminate barriers between skilled workers and employment opportunities</li>
                  <li>Provide verified credentials that employers can trust</li>
                  <li>Create a seamless, user-friendly platform that saves time for both job seekers and employers</li>
                  <li>Support Australian businesses in finding the right talent to grow and succeed</li>
                  <li>Build stronger communities by connecting local talent with local opportunities</li>
                  <li>Ensure compliance and safety through rigorous verification processes</li>
                </ul>
                <p className="mt-6">
                  Ultimately, we envision a future where every skilled Australian worker can easily find meaningful employment, and every business can quickly discover the perfect candidate to help them thrive.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="py-20 bg-gray-50 dark:bg-gray-800">
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <Card className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 shadow-lg hover:shadow-xl transition-all duration-300 group overflow-hidden">
              <div className="relative h-48">
                <div className="absolute inset-0 bg-gradient-to-r from-[#B260E6]/80 to-[#ED84A5]/80" />
            ...
            <Card className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 shadow-lg hover:shadow-xl transition-all duration-300 group overflow-hidden">
              <div className="relative h-48">
                ...
                /> */}
                <div className="absolute inset-0 bg-gradient-to-r from-[#ED84A5]/80 to-[#B260E6]/80" />
                <div className="absolute bottom-6 left-6 text-white">
                  <div className="w-12 h-12 bg-white/20 backdrop-blur-sm rounded-xl flex items-center justify-center text-white text-xl mb-4">
                    🔭
                  </div>
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {team.map((member, index) => (
              <Card 
                key={index} 
                className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 shadow-lg hover:shadow-xl transition-all duration-300 group overflow-hidden"
              >
      ...
      <div className="relative">
        ...
        <div className="hidden lg:block space-y-12">
          {milestones.map((milestone, index) => (
            <div 
              key={index} 
              className={`flex items-center group cursor-pointer transition-all duration-500 ${
            ...
            >
              ...
              <div className="relative z-10 w-1/12 flex justify-center">
                <div className={`w-6 h-6 bg-white rounded-full border-4 ${
                  index === currentSlide ? 'border-white scale-125' : 'border-[#B260E6]'
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {values.map((value, index) => (
              <Card 
                key={index} 
                className="bg-white border border-gray-200 shadow-lg hover:shadow-xl transition-all duration-300 group overflow-hidden hover:scale-105"
              >
